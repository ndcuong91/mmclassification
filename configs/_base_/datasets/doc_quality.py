...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_prefix='/home/cuongnd/PycharmProjects/document_quality_dataset/doc_quality_ekyc/train',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        data_prefix='/home/cuongnd/PycharmProjects/document_quality_dataset/doc_quality_ekyc/val',
